...
With the estimates, we have the marginal pdf of $Y$: $f_Y(y)=(1-0.4454)\phi(y| 1.0832,0.9008)+\pi\phi(y| 4.6559, 0.9049)$

Suppose a new point is observed $y_{new}=3$, we can derive $f_Y(y_{new})$
...
The probability of being classified into groups are shown as
